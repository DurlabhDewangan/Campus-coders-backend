...
import { comment, createPost, deleteComment, deletePost, getAllComment, getAllPosts, getMyPost, getUserPost, postLike, postUnlike } from "../controllers/post.controller.js";
